...
| WiFi 模块 | ESP8266 | USART2 (PA2/PA3) | ✅ 已完成 |
...
│   │   └── lock.h
│   └── ESP8266/
│       ├── esp8266.c           # ESP8266 WiFi 驱动（AT 指令通信）
│       └── esp8266.h
├── Docs/                       # 文档和原理图
├── Tests/                      # 测试代码
└── README.md
...
### ESP8266 WiFi
- USART2 串口通信，115200 波特率，中断接收
- AT 指令控制：Station 模式 → 连 WiFi → 建立 TCP 连接 → 发送数据
- JSON 格式上报事件，方便服务器解析
- 支持：连接 WiFi、TCP 通信、事件上报、获取 IP 地址
